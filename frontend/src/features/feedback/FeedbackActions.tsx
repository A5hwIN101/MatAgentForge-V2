...
export function FeedbackActions({ critiqueId, onFeedback }: FeedbackActionsProps) {
  ...
  return (
    <div className="w-full max-w-3xl rounded-[1.75rem] border border-slate-800 bg-slate-950/55 p-4">
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className="rounded-full border border-rose-500/70 px-5 py-2.5 text-sm font-semibold text-rose-200 transition hover:bg-rose-500/10 disabled:cursor-not-allowed disabled:opacity-60"
        >
          REJECT
        </button>
        <button
          ...
          className="rounded-full border border-sky-500/70 px-5 py-2.5 text-sm font-semibold text-sky-200 transition hover:bg-sky-500/10 disabled:cursor-not-allowed disabled:opacity-60"
        >
          MODIFY
        </button>
      </div>
      ...
      {activeAction ? (
        <div className="mt-4 rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
          <label className="block text-sm font-medium text-slate-200" htmlFor={`feedback-${critiqueId}`}>
          ...
          <input
            ...
            className="mt-3 h-11 w-full rounded-xl border border-slate-700 bg-slate-950/80 px-4 text-sm text-slate-100 outline-none transition placeholder:text-slate-500 focus:border-cyan-400"
          />
          <div className="mt-3 flex gap-3">
            ...
            <button
              ...
              className="rounded-full border border-slate-700 px-4 py-2 text-sm font-semibold text-slate-300 transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60"
            >
              Cancel
            </button>
          </div>
